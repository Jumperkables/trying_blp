...
python -W ignore /home/jumperkables/kable_management/blp_paper/tvqa/main.py \
    ...
    --jobname=tucker_svi \
    --results_dir_base=/home/jumperkables/kable_management/blp_paper/.results/tvqa/tucker_svi \
    --modelname=tvqa_abc_bert_nofc \
    --lrtype radam \
    --bsz 1 \
    --log_freq 6400 \
    --test_bsz 1 \
    --lanecheck_path /home/jumperkables/kable_management/blp_paper/.results/tvqa/tucker_svi/lanecheck_dict.pickle \
    --pool_type Tucker \
